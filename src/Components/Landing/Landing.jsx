            ...
            <div class="row align-items-center g-5">
              <div class="col-lg-7">
                <div class="banner-content">
                  <h1>
                    {" "}
                    <span class="theme-color-4">Create, Collect And</span>{" "}
                  ...
                  <SwiperSlide className="carde">
                    <Card className="inner" style={{ width: "22rem" }}>
                      ...
                      <Card.Body className="bdy">
                        <Card.Title className="tittl">Metahorse</Card.Title>
                      </Card.Body>
                    </Card>
                  </SwiperSlide>
              ...
              <div class="col-lg-2 col-sm-4 col-6">
                <div class="wallet-item home-4">
                  <div class="wallet-item-inner text-center">
                    <div class="wallet-thumb">
                      <a href="#">
                        <img src="binancw.png" alt="wallet-img" />
                      </a>
                    </div>
                    <div class="wallet-content">
                      <h5>
              ...
              <div class="col-lg-2 col-sm-4 col-6">
                <div class="wallet-item home-4">
                  <div class="wallet-item-inner text-center">
                    <div class="wallet-thumb">
                      <a href="#">
                        <img src="formatic.png" alt="wallet-img" />
                      </a>
                    </div>
                    <div class="wallet-content">
                      <h5>
              ...
              <div class="col-lg-2 col-sm-4 col-6">
                <div class="wallet-item home-4">
                  <div class="wallet-item-inner text-center">
                    <div class="wallet-thumb">
                      <a href="#">
                        <img src="autherem.png" alt="wallet-img" />
                      </a>
                    </div>
                    <div class="wallet-content">
                      <h5>
              ...
              <div class="col-lg-2 col-sm-4 col-6">
                <div class="wallet-item home-4">
                  <div class="wallet-item-inner text-center">
                    <div class="wallet-thumb">
                      <a href="#">
                        <img src="coinbase.png" alt="wallet-img" />
                      </a>
                    </div>
                    <div class="wallet-content">
                      <h5>
