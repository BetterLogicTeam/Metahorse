                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        <div class="footer-link-item">
                           ...
                           <ul class="footer-link-list">
                              ...
                              <li><Link to="" class="footer-link">White Paper</Link></li>
                              <li><a href="contact.html" class="footer-link"><Link to="/Contact_main">User Support</Link> </a></li>
                              <li><Link to="" class="footer-link">Report a Bug</Link></li>
                     ...
                     <div class="col-md-3">
                        <div class="footer-link-item">
                           <h5>Quick Links</h5>
                           <ul class="footer-link-list">
                              <li><a href="#" class="footer-link">Buy Metahorse</a></li>
